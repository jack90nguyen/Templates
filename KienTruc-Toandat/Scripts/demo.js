...
function bindDataElement(element) {
    ...
    if (source === 'header-nav') {
        strContent += `<a class="navbar-item" href="/">Trang chủ</a>
            <a class="navbar-item" href="/about.html">Về chúng tôi</a>
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown">
                    <a class="navbar-item" href="/images.html">Thư viên hình ảnh</a>
                    <a class="navbar-item" href="/videos.html">Thư viên videos</a>
                </div>
            </div>
            <a class="navbar-item" href="/apps.html">Ứng dụng</a>
