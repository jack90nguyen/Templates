...
$(document).ready(function () {
    ...
    setTimeout(function () {
        ...
        $('#footer .icon').click(function (e) {
            ...
            $('#footer .icon').removeClass('is-active');
        ...
        var listNav = $('#footer .icon');
        for (var i = 0; i < listNav.length; i++) {
            var item = listNav[i];
            if (item.href.indexOf(location.href) !== -1)
                item.className = item.className + ' is-active';
        }

    }, 500);

    setTimeout(function () {
        $('#hotline').addClass('animated infinite tada is-active');
    }, 5000);
